...
static const variant_info_t lime_info = {
    ...
    .marketname = "Redmi 9T",
    .model = "M2010J19SG",
    .build_fingerprint = "Redmi/lime_global/lime:12/RKQ1.211130.001/V13.0.2.0.SJQMIXM:user/release-keys",
...
static const variant_info_t pomelo_info = {
    ...
    .model = "M2010J19SL",
    .build_fingerprint = "Redmi/pomelo_global/pomelo:12/RKQ1.211130.001/V13.0.2.0.SJQMIXM:user/release-keys",
...
static const variant_info_t lemon_info = {
    ...
    .model = "M2010J19SY",
    .build_fingerprint = "Redmi/lemon_global/lemon:12/RKQ1.211130.001/V13.0.2.0.SJQMIXM:user/release-keys",
